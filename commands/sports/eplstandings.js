...
module.exports = async (sock, msg, from, body, args) => {
    try {
        ...
        const url = `https://api.princetechn.com/api/football/epl/standings?apikey=prince`;
        const res = await axios.get(url, { timeout: 30000 });

        if (!res.data || !res.data.success || !res.data.result) {
            return sock.sendMessage(from, { text: "❌ Failed to fetch EPL standings." }, { quoted: msg });
        }
        ...
        console.log("EPL Standings Error:", e.message);
